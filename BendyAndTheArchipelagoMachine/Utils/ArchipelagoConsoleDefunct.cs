...
namespace BendyAndTheArchipelagoMachine.Utils
{
    ...
    public static class ArchipelagoConsoleDefunct
    {
        ...
        public static void OnGUI()
        {
            ...
            if (!Hidden || Time.time - lastUpdateTime < HideTimeout)
            {
                ...
                GUI.Window(0, window, (GUI.WindowFunction)WindowFunc, "Test");  
                //GUI.Box(text, "");
        ...
        public static void WindowFunc(int windowID)
        {
            ...
            {
                BendyAndTheArchipelagoMachine.Logger.LogMessage("Got a click in window with color ");
            }

            GUI.Box(text, "Testing this now \n does it work?");
            GUI.Box(text, scrollText, textStyle);
